...
e "../../../../app/Funcoes/funcoesAdmin.php";
	...
	$verificar_senha_atual = 0;
		...
		if(isset($_POST['email']) AND $_POST['email'] AND isset($_POST['remetente']) AND $_POST['remetente'] AND isset($_POST['enviar_email']) AND $_POST['enviar_email'] AND (LUGAR == 'admin' OR LUGAR == 'vendedores')  AND isset($_SESSION['x_admin']->id) AND $_SESSION['x_admin']->id){
